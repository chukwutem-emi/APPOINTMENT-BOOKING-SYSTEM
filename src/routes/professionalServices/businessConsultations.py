    ...
    try:
        ...
        with db.engine.connect() as connection:
            ...
            if len(personnel_data) ==0:
                return jsonify({"message":"The business-consultant personnel you selected doesn't exist or he/she might have been deleted from the database."}), 404
