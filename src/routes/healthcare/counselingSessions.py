    ...
    try:
        ...
        with db.engine.connect() as connection:
            ...
            if len(personnel_data) ==0:
                return jsonify({"message":"The healthcare-counseling personnel you selected doesn't exist or he/she might have been deleted from the database."}), 404
