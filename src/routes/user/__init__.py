...
user_bp.add_url_rule(rule="/user", endpoint="user", view_func=get_user, methods=["GET", "OPTIONS"])
user_bp.add_url_rule(rule="/users", endpoint="users", view_func=get_users, methods=["GET", "OPTIONS"])
